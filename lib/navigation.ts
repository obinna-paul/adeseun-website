 ...
 * (The Screening Room, The Boardroom) — real navigation dead ends caught
 * during the pre-deploy audit. Both consumers honor the flag rather than
 * silently linking to a 404: Footer shows the name but strips the link
 * and greys it with a "Soon" note; the 404 page's "here's where you can
 * actually go" grid drops unbuilt rooms entirely (a 404 page is the last
 * place that should link to another dead end). Flip to `true` the same
 * commit the page ships in — nothing else to update.
 */
export const SITE_ROOMS = [
  { name: "The Foyer", href: "/", note: "Home", built: true },
  { name: "The Library", href: "/library", note: "Books", built: true },
  { name: "The Screening Room", href: "/screening-room", note: "Videos & Media", built: false },
