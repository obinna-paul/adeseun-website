        ...
        return (
          <li key={social.label}>
            <a
              ...
              className="group relative flex h-11 w-11 items-center justify-center overflow-hidden rounded-full border border-line text-text-subdued transition-colors duration-300 ease-gallery-standard hover:border-gold hover:text-text-on-dark"
            >
              <span
                aria-hidden="true"
                className="absolute inset-0 rounded-full bg-gold-fill transition-[clip-path] duration-300 ease-gallery-out [clip-path:circle(0%_at_50%_50%)] group-hover:[clip-path:circle(100%_at_50%_50%)]"
              />
