...
/**
 * Every one of `book.excerpt`'s paragraphs, flattened across all eight
 ...
 * library-content.ts's own doc comment is explicit that seven of these
 * eight books' excerpt text is site-original summary, not a verbatim
